...
mvn exec:java -Dexec.mainClass=edu.cmu.reedsolomonfs.server.Master.Master -Dexec.classpathScope="compile" -Dexec.additionalClasspath="/maven-repo/reed-solomon-1.0.jar"
