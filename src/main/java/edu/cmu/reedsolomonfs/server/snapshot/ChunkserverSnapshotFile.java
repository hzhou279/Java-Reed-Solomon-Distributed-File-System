 ...
 */
package edu.cmu.reedsolomonfs.server.snapshot;
 ...
 */
public class ChunkserverSnapshotFile {

    private static final Logger LOG = LoggerFactory.getLogger(ChunkserverSnapshotFile.class);

    private String              path;

    public ChunkserverSnapshotFile(String path) {
        super();
        this.path = path;
    }
