...
command2="/usr/bin/env /home/vscode/.vscode-remote/extensions/redhat.java-1.20.0-linux-x64/jre/17.0.7-linux-x86_64/bin/java @/tmp/cp_6yhsvqz4vybfj8mpr34hss8w.argfile edu.cmu.reedsolomonfs.server.Chunkserver chunkserver2 cluster 127.0.0.1:8082 127.0.0.1:8081,127.0.0.1:8082,127.0.0.1:8083,127.0.0.1:8084,127.0.0.1:8085,127.0.0.1:8086 1"

command3="/usr/bin/env /home/vscode/.vscode-remote/extensions/redhat.java-1.20.0-linux-x64/jre/17.0.7-linux-x86_64/bin/java @/tmp/cp_6yhsvqz4vybfj8mpr34hss8w.argfile edu.cmu.reedsolomonfs.server.Chunkserver chunkserver3 cluster 127.0.0.1:8083 127.0.0.1:8081,127.0.0.1:8082,127.0.0.1:8083,127.0.0.1:8084,127.0.0.1:8085,127.0.0.1:8086 2"
